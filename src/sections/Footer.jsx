    ...
    <footer>
      <div className='flex justify-center items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          <p className='mt-6 text-base leading-7 font-montserrat text-white sm:max-w-sm'> Get the most in-demand shoe at your nearest NIKE store</p>
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li className='text-white mt-3 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer'>{link.name}</li>
                ))}
              </ul>
            </div>
          ))}
